<template>
	<div id="test">
		...
		<input :value="inputNum" @input="ChangeInputNum" type="text" placeholder="숫자입력테스트" @keyup.enter="go()" /><br />
		...
		<h2>{{ inputName }}</h2>
		<my-button title="Prop 전달 타이틀" @myButtonClick="emitClick"></my-button><br />
		<input v-model="tempObj.name" placeholder="Object Watch 테스트 Name" /><br />
